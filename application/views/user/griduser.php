    ...
    $(document).ready(function(){
        var dgUser = $("#dg").datagrid({
            ...
            onClickRow:function(index,row){
                var userpk = row.userpk;
                 $.ajax({
                    url:"<?php echo base_url(); ?>user/set/?userpk="+userpk,
...
<div class="easyui-tabs" style="height:auto">
    ...
    <div data-options="closable:false,cache:false,href:'<?php echo base_url(); ?>useracl/user'" title="Data User Acl" style="padding:10px" ></div>
</div>